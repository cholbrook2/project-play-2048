...
def play2048( times ):
    browser = webdriver.Firefox() #open in Firefox
    browser.get('https://gabrielecirulli.github.io/2048/') #1 open game

    htmlElem = browser.find_element_by_tag_name('html')
    scoreElem = browser.find_element_by_class_name('score-container') #2
